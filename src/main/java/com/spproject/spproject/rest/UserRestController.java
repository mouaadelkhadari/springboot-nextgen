...
public class UserRestController {
    ...
    @ExceptionHandler
    public ResponseEntity<UserErrorResponse> handlerException(UserNotFoundException exception) {
    ...
    @ExceptionHandler
    public ResponseEntity<UserErrorResponse> handlerException(Exception exception) {
        UserErrorResponse error = new UserErrorResponse();
